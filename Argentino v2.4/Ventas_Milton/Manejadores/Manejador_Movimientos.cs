...
namespace Ventas_Milton.Manejadores
{
    class Manejador_Movimientos
    {
        ...
        /**********************************************CONSULTAS************************************************/
        public DataTable BuscarMovimiento(string parametro, csMovimiento mov)
        {
            int opcion = 0;
        ...
        public void ActualizarRegistro(string parametro, csMovimiento mov)
        {
            int opcion = 0;
            DataTable dt = new DataTable();
        ...
        /*******************************INSERCIONES****************************/
        public int RegistrarNuevoMovimiento(csMovimiento mov)
        {
            int idInsertado;
        ...
        public int ingresarCompra(csMovimiento mov)
        {
            return movimiento.ingresarCompra(mov);
        }
    }
}

...
namespace Ventas_Milton.Vista
{
    public partial class frmPrincipal : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows[0]["Login"].ToString() == u.Login && dt.Rows[0]["Clave"].ToString() == u.Clave)
            {
                if (int.Parse(dt.Rows[0]["Modo"].ToString()) != 1)
                {
                    ...
                    txtUsuarioActual.Text = u.IdUsuario.ToString();
                }
                else
                {
        ...
        {
            frmProducción x = new frmProducción(txtUsuarioActual.Text);
            x.lblTitulo.Text = ".: Nueva Venta :.";
        ...
        private void btnArbolDeMercaderias_Click(object sender, EventArgs e)
        {
            frmMercaderia m = new frmMercaderia();
            m.MdiParent = this;
            m.Show();
        }       
    }
